...
<p align="center">
  <sub>▸ <a href="https://github.com/desplega-ai/agent-swarm/blob/main/assets/agent-swarm.mp4">daily evolution</a> · <a href="https://github.com/desplega-ai/agent-swarm/blob/main/assets/agent-swarm-slack-to-pr.mp4">slack → pr</a> · <a href="https://github.com/desplega-ai/agent-swarm/tree/main/assets/video-source">Making of</a></sub>
</p>
...
For production deployments (Docker Compose with multiple workers, systemd for the API, graceful shutdown, integration config), see [DEPLOYMENT.md](https://github.com/desplega-ai/agent-swarm/blob/main/DEPLOYMENT.md) and the [deployment guide](https://docs.agent-swarm.dev/docs/guides/deployment).
...
See [CONTRIBUTING.md](https://github.com/desplega-ai/agent-swarm/blob/main/CONTRIBUTING.md) to get started. The quickest way to contribute:
...
[MIT](https://github.com/desplega-ai/agent-swarm/blob/main/LICENSE) — 2025-2026 [desplega.sh](https://desplega.sh)
